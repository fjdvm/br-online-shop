...
public sealed class ActiveContentReaderTests
{
    ...
    public async Task GetActiveContent_returns_content_when_crms_returns_200()
    {
        ...
        content.Html.Should().Be("<div>Free shipping!</div>");
    ...
    public async Task GetActiveContent_serves_from_cache_within_30s_window_and_expires_after()
    {
        ...
        content1!.Html.Should().Be("Cached Banner");
        ...
        handler.RequestCount.Should().Be(1);
        content2!.Html.Should().Be("Cached Banner");
        ...
        content3!.Html.Should().Be("Cached Banner");
    }

    [Fact]
    public async Task GetActiveContent_caches_independently_per_channel()
    {
        const string bannerJson = """{"channel": "Banner", "html": "Banner Content"}""";
        const string popupJson = """{"channel": "Popup", "html": "Popup Content"}""";
        ...
        handler.RequestCount.Should().Be(2);
        banner1!.Html.Should().Be("Banner Content");
        popup1!.Html.Should().Be("Popup Content");
        ...
        handler.RequestCount.Should().Be(2);
        banner2!.Html.Should().Be("Banner Content");
        popup2!.Html.Should().Be("Popup Content");
    }
    ...
    public async Task GetActiveContent_transient_error_is_not_cached()
    {
        ...
        var handler = new DynamicStubHandler(_ =>
        {
            ...
            const string json = """{"channel": "Banner", "html": "Recovered Content"}""";
        ...
        secondResult!.Html.Should().Be("Recovered Content");
        handler.RequestCount.Should().Be(2);
    }
