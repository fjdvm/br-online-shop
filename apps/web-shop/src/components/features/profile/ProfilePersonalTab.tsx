...
import { NAME_MAX, PHONE_MAX } from "@/lib/validators/auth";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <CharacterCount value={watch("fullName") ?? ""} max={NAME_MAX} />
          </div>
          <Input id="prof-name" type="text" maxLength={NAME_MAX} {...register("fullName")} />
          {errors.fullName && (
