...
import { forgotPasswordSchema, type ForgotPasswordFormData, EMAIL_MAX } from "@/lib/validators/auth";
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input id="forgot-email" type="email" placeholder="name@example.com" maxLength={EMAIL_MAX} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
