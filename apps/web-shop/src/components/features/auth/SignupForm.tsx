...
import { registerSchema, type RegisterFormData, NAME_MAX, EMAIL_MAX, PASSWORD_MAX } from "@/lib/validators/auth";
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center justify-between">
                      ...
                      <CharacterCount value={field.value} max={NAME_MAX} />
                    </div>
                    <FormControl>
                      <Input id="signup-name" type="text" placeholder="John Doe" maxLength={NAME_MAX} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input id="signup-email" type="email" placeholder="name@example.com" maxLength={EMAIL_MAX} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="space-y-2 py-2">
                    <FormLabel className="text-xs font-normal text-on-surface-variant">
                      Would you like to receive marketing emails about new arrivals and promotions?
                    </FormLabel>
                    <FormControl>
