  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await apiClient.post("/contact", {
        orderRef: trimField(formData.orderRef),
        email: normalizeEmailInput(formData.email),
        category: formData.category,
        message: trimField(formData.message),
      });
      setIsSuccess(true);
      ...
      <form onSubmit={handleSubmit} className="relative z-10 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <CharacterCount value={formData.orderRef} max={ORDER_REF_MAX} />
            </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <CharacterCount value={formData.email} max={EMAIL_MAX} />
            </div>
            <div className="relative">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <CharacterCount value={formData.message} max={MESSAGE_MAX} />
          </div>
          <textarea
            id="message"
            required
